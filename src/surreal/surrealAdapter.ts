...
export function SurrealAdapter(inputs: {
  ...
  return {
    async createUser(data) {
      console.log("SurrealAdapter", "createUser", data.email);
    ...
    async getUser(id) {
      console.log("SurrealAdapter", "getUser", id);
      const client = await inputs.getDB();
    ...
    async getUserByEmail(email) {
      console.log("SurrealAdapter", "getUserByEmail", email);
      const client = await inputs.getDB();
    ...
    async updateUser(user) {
      //   console.log("SurrealAdapter", "updateUser", user.email));
      const { id, ...data } = user;
      const client = await inputs.getDB();
    ...
    async deleteUser(id) {
      console.log("SurrealAdapter", "deleteUser", id);
      const client = await inputs.getDB();
      await client.query(`DELETE user:${id};`);
      return;
    },
    async linkAccount(data) {
      console.log("SurrealAdapter", "linkAccount", data.userId);
    ...
    async createSession(data) {
      console.log("SurrealAdapter", "createSession", data.userId);
    ...
    async getSessionAndUser(sessionToken) {
      console.log("SurrealAdapter", "getSessionAndUser");
    ...
    async updateSession(data) {
      console.log("SurrealAdapter", "updateSession");
      const client = await inputs.getDB();
      data.sessionToken;
      const session_data = await client.query(
    ...
    async deleteSession(sessionToken) {
      console.log("SurrealAdapter", "deleteSession");
    ...
    async createVerificationToken(data) {
      console.log("SurrealAdapter", "createVerificationToken", data.identifier);
      const client = await inputs.getDB();
    ...
    async useVerificationToken({ identifier, token }) {
      console.log("SurrealAdapter", "useVerificationToken", identifier);
      try {
        const client = await inputs.getDB();
        const verification_token_data = await client.query(
